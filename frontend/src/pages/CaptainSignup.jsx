...
const SignUpPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-100 px-4 py-4">
      <div className="w-full relative max-w-lg bg-white text-black rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={(e) => handleSubmit(e)} className="space-y-4">
          ...
          {/* Vehicle Details */}
          <h2 className="text-lg font-bold text-gray-700 mt-6">
            Vehicle Details
          </h2>
          <div>
            <label
          ...
          {/* Submit Button */}
          <div>
            <button className="w-full flex items-center justify-center gap-3 bg-gray-200 hover:bg-gray-300 text-black font-semibold py-2 px-4 rounded-lg transition duration-300">
              Sign Up as Captain
              <RiMotorbikeFill />
            </button>
          </div>
        ...
        <img
          className="h-8 absolute bottom-0"
          alt=""
