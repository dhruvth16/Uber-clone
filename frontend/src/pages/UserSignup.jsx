...
const SignUpPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-100 px-4 py-4">
      <div className="w-full relative max-w-sm bg-white text-black rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={(e) => handleSubmit(e)} className="space-y-4">
          ...
          {/* Submit Button */}
          <div>
            <button className="w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-300">
              Sign Up as User
              <RiMotorbikeFill />
            </button>
          </div>
